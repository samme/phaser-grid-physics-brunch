...
var gridBody = function () {
    ...
    _createClass(gridBody, [{
        ...
        value: function collideTilemap(dx, dy) {
            ...
            for (var x = position.x; x < position.x + this.width; x++) {
                for (var y = position.y; y < position.y + this.height; y++) {
                    var collide = false;
        ...
        value: function moveToXY(x, y) {
            ...
            var grid = [];
            var i = 0;
            var tileRatio = { x: this.physics.tilemaplayers[0].layer.data[0][0].width / game.physics.gridPhysics.gridSize.x, y: this.physics.tilemaplayers[0].layer.data[0][0].height / game.physics.gridPhysics.gridSize.y };
...
module.exports = _gridPhysics2.default;
